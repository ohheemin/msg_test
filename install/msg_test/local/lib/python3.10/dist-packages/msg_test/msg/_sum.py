...
class Metaclass_Sum(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('msg_test')
        except ImportError:
            import logging
            import traceback
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sum
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sum
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sum
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sum
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sum
