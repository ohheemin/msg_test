...
bool msg_test__msg__sum__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg_test.msg._sum.Sum", full_classname_dest, 21) == 0);
  }
  msg_test__msg__Sum * ros_message = _ros_message;
  {  // a
...
{
  /* NOTE(esteve): Call constructor of Sum */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg_test.msg._sum");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Sum");
